...
class Calculator extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement("h1", { id: "display" }, this.state.result), /*#__PURE__*/
      React.createElement("button", { className: "equal", onClick: this.handleEqualClick, id: "equals" }, "="), /*#__PURE__*/
      ...
      React.createElement("button", { onClick: () => this.handleClick("+"), id: "add", className: "operation-btn add" }, "+"), /*#__PURE__*/


      React.createElement("button", { onClick: () => this.handleClick("-"), id: "subtract", className: "operation-btn subtract" }, "-"), /*#__PURE__*/


      React.createElement("button", { onClick: () => this.handleClick("*"), id: "multiply", className: "operation-btn multiply" }, "x"), /*#__PURE__*/


      React.createElement("button", { onClick: () => this.handleClick("/"), id: "divide", className: "operation-btn divide" }, "/"), /*#__PURE__*/


      React.createElement("button", { className: "clear", onClick: this.clear, id: "clear" }, "AC"))));
